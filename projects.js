    ...
    "data": {
        "projects": [
            ...
            },
            {
                ...
                "description": "A rough draft of a ‘Ticket Master’-like service written in Java made as a group. Automated testing is used for unit testing and stress testing. User stories were used as part of the creation process.",
            ...
            },
            {
                ...
                "description": "A live messaging app which has a server side and client sides with messages being stored in an intermediatory Azure SQL database. Individual session keys(AES) are created for clients which are encrypted using asymmetrical encryption methods (RSA).",
